// Cliente HTTP para a AllowPay. A api_key nunca sai deste módulo em direção ao navegador.
...
if (!ALLOWPAY_API_KEY) {
    throw new Error('ALLOWPAY_API_KEY não configurada. Defina no arquivo server/.env');
}
